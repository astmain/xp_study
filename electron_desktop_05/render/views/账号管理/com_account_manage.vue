<template>
  <el-dialog v-if="show_com_account_manage" title="管理账号" width="1200px" v-model="show_com_account_manage" draggable :close-on-click-modal="false" :destroy-on-close="true">
    ...
    <div>douyin_1844606013</div>
    <div>douyin_94667114450</div>
...
export default {
  data() {
    return {
      ...
      test: {
        ...
        options: [
          {id: 1, name: "盾牌", partition: "persist:douyin_1844606013", webview_name: "douyin_1844606013"},
          {id: 2, name: "衣服2", partition: "persist:douyin_94667114450", webview_name: "douyin_94667114450"},
        ],
  ...
  methods: {
    ...
    async get_env_data() {
      ...
      let cookies_str = await axios_api({method: 'get', url: "ipc/get_cookies_str", params: {partition: partition, url: "https://creator.douyin.com"}})
