const {send_publish_status} = require("../../send_publish_status")
const Spider = require("../../puppeteer/Spider")

module.exports = async function run_api_img({acc, data, env}) {
    ...
    try {
        ...
        //     "at_friend": [], "activate": [], "topic": [],
        //     "address": {}, "collection": {}, "music": {}, "visibility_type": "0", "download": "1", "hot": "", "challenge_tag": {},
        // }
        ...
        send_publish_status(acc, 3, `发布失败:${error.message}`, true)
        return error
    }
