...
const routes = [//
    ...
    {path: '/Setting', name: "设置", component: () => import('./Layout/Setting.vue'), kind: "bottom"},//
    {path: '/测试平台', name: "测试平台", component: () => import('./views/测试平台/测试平台.vue'), kind: "bottom"},//
    {path: '/测试拖拽', name: "测试拖拽", component: () => import('./views/测试拖拽/测试拖拽.vue'), kind: "bottom"},//
    {path: '/音乐播放器', name: "音乐播放器", component: () => import('./views/音乐播放器/音乐播放器.vue'), kind: "bottom"},//
    {path: '/账号管理', name: "账号管理", component: () => import('./views/账号管理/账号管理.vue'),},//

    // {path: '/账号管理demo', name: "账号管理demo", component: () => import('./views/账号管理demo/账号管理demo.vue'),},//
