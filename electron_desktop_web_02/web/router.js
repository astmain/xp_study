...
const routes = [//
    ...
    {
        path: '/数据爬虫', name: '数据爬虫', component: LayoutView, children: [//
            {path: '/数据爬虫/数据爬虫', name: '数据爬虫1', component: () => import('./views/数据爬虫/数据爬虫.vue')},//
        ]
    }, //
...
const router = createRouter({
    history: createWebHistory(import.meta.env.BASE_URL), routes: routes_new,
})
