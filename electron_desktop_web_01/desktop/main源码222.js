...
async function main() {
    ...
    globalThis.accounts = {
        //     account1: {url: "https://www.bilibili.com", view: new WebContentsView({webPreferences: {partition: 'persist:account1'}})}, //
        //     account2: {url: "https://www.baidu.com", view: new WebContentsView({webPreferences: {partition: 'persist:account2'}})},//
    }
